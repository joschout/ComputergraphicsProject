...
public class MeshTriangle extends Shape{
	...
	public static Boolean phongInterpolation = true;
	...
	public static void setPhongInterpolation(Boolean shouldPhongInterpolate){
		phongInterpolation = shouldPhongInterpolate;
	}
}
